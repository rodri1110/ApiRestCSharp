...
namespace SalesApiCSharp.Models
{
    public class Seller
    {
        ...
        [RegularExpression(@"^[a-zA-Z]+[ a-zA-Z]*$", ErrorMessage = "{0} must contain alphabetic letters")]
        ...
        public double TotalSales(DateTime initial, DateTime final)
        {
            ...
            && salesRecord.Date <= final).Sum(salesRecord => salesRecord.Amount);
        }
    }
}
